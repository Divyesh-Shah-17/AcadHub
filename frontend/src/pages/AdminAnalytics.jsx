...
export const AdminAnalytics = () => {
  ...
  const getOverallAverage = () => {
    ...
    const sum = ledgerData.reduce((acc, curr) => acc + curr.consolidatedScore, 0);
    return (sum / ledgerData.length).toFixed(1);
  };
    ...
    <div className="space-y-8 animate-fade-in">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
          ...
          <p className="text-3xl font-black text-slate-800 mt-2">{studentsCount}</p>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
          <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Total Teachers</p>
          <p className="text-3xl font-black text-slate-800 mt-2">{teachersCount}</p>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
          <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Active Groups</p>
          <p className="text-3xl font-black text-slate-800 mt-2">{groupsCount}</p>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
          <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Average Performance</p>
          <p className="text-3xl font-black text-indigo-600 mt-2">{getOverallAverage()} / 10</p>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
        <div className="flex items-center space-x-2 mb-6">
          ...
          <h2 className="text-xl font-bold text-slate-800">Consolidated Ledger</h2>
        </div>
